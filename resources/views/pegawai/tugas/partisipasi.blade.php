                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="flex flex-col sm:flex-row justify-between w-full gap-4 mb-4">
                        <div class="flex-shrink-0">
                            <a href="{{ route('tugas.partisipasi.export', request()->query()) }}" class="inline-flex items-center px-2 py-1 bg-green-600 border border-transparent rounded-md font-semibold text-[10px] text-white hover:bg-green-700 active:bg-green-900 focus:outline-none focus:border-green-900 focus:ring ring-green-300 disabled:opacity-25 transition ease-in-out duration-150 shadow-sm">
