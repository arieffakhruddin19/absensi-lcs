...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-900 antialiased bg-[conic-gradient(at_top_right,_var(--tw-gradient-stops))] from-blue-900 via-indigo-800 to-blue-900">
        <div class="min-h-screen flex flex-col justify-center items-center p-4 sm:p-0 relative overflow-hidden">
            ...
            <!-- Main Card -->
            <div class="z-10 w-[92%] sm:w-full max-w-md px-6 sm:px-8 py-10 bg-white/95 backdrop-blur-xl shadow-2xl overflow-hidden rounded-3xl transition-all duration-300">
